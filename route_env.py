...
class OneLayer(Env):
    ...
    def __init__(self, n, m):
        ...
        self._agent_location = np.array((self.n-1, self.m-1), dtype=np.int8)
        self._target_location = np.array((0, 0), dtype=np.int8)
    ...
    def reset(self, seed=None, return_info=False, options=None):
        ...
        self._agent_location = np.array((self.np_random.randint(self.n), self.np_random.randint(self.m)), dtype=np.int8)
    ...
    def step(self, action):
        ...
        self._agent_location = np.array((ii, jj), dtype=np.int8) 
...
def test_A():
    ...
    def t( state, action, new_state, new_reward, new_done):
        env._agent_location = np.array(state, dtype=np.int8)
